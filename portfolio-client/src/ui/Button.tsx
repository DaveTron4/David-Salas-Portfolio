...
import { cn } from "../lib/utils" // Adjust this path to your utils.ts file
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    // A quick note on your original import:
    // You don't include version numbers in the import statement itself.
    // The version is managed by your package.json file.
    // Correct: import { Slot } from "@radix-ui/react-slot";
